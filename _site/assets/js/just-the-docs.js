...
function initSearch() {
  ...
  request.open('GET', '/supercomputing-for-ai-book/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/supercomputing-for-ai-book/assets/css/just-the-docs-' + theme + '.css');
}
