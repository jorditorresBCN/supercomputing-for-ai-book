# Launching and Structuring Parallel Programs 
...
<tr>
<td style="text-align: center;">PyTorch (torchrun<a href="#fn1" class="footnote-ref" id="fnref1" role="doc-noteref"><sup>1</sup></a>)</td>
<td style="text-align: left;"><p>multi-node,</p>
<p>multi-GPU</p></td>
...
<hr />
<ol>
<li id="fn1"><p>PyTorch provides a built-in launcher (torchrun) and a distributed wrapper (DistributedDataParallel, or DDP) to scale training across GPUs.<a href="#fnref1" class="footnote-back" role="doc-backlink">↩︎</a></p></li>
</ol>
</section>
